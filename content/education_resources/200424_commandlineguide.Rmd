---
title: "Command Line Master Guide"
...
**Software Carpentry 'The Unix Shell'** is a course that will help you get started with learning how to use the CLI in shell. The course can be accessed [here](http://swcarpentry.github.io/shell-novice/).
...
**Unix Cheat Sheet** has a list of commands that are great for a quick reference. To access it, click [here](http://cheatsheetworld.com/programming/unix-linux-cheat-sheet/).
